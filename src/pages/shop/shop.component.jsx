...
import ShopCatalogue from '../../components/shop-catalogue/shop-catalogue.component';
...
class Shop extends React.Component {
    ...
    render(){
        ...
        return (
            <div className='shop'>
            {
                SHOP_DATA.map(({id, imageUrl, title, linkUrl}) => <ShopCatalogue key={id} imageUrl={imageUrl} title={title} linkUrl={linkUrl} />)
            }
            </div>
        );
    }
